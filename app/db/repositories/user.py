...
from app.db.repositories.profile import UserProfileRepository
from app.models.profile import UserProfileCreate, UserProfilePublic
...
class UserRepository(BaseRepository):
    ...
    async def register_new_user(self, *, new_user: UserCreate) -> UserInDB:
        ...
        await self.profiles_repo.create_profile_for_user(
            profile_create=UserProfileCreate(user_id=created_user["id"]))
    ...
    async def authenticate_user(self,
        ...
        if not self.auth_service.verify_password(password=password,
                                                 salt=user.salt,
